...
import { MonedaIndex } from './moneda-index.model';
import { AppConfig } from '../../../../_core/services/app-config.service';

@Injectable({
  providedIn: 'root'
})
export class MonedaService extends TableService<MonedaIndex> implements OnDestroy {
  // eslint-disable-next-line @typescript-eslint/naming-convention
  API_URL = '';

  constructor(@Inject(HttpClient)  http) {
    super(http);
    this.API_URL = `${AppConfig.settings.api}/api/banca-movil/admin/moneda`;
  }
