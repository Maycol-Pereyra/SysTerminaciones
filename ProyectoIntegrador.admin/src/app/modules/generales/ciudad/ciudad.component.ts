...
import { EditCiudadModalComponent } from './components/edit-ciudad-modal/edit-ciudad-modal.component';
...
export class CiudadComponent
  ...
  create() {
    if (this.accesosService.puedeCrear('generales.ciudad.crear')) {
      const modalRef = this.modalService.open(EditCiudadModalComponent, { size: 'md', backdrop: 'static' });
  ...
  edit(id: number) {
    if (this.accesosService.puedeEditar('generales.ciudad.editar')) {
      const modalRef = this.modalService.open(EditCiudadModalComponent, { size: 'md', backdrop: 'static' });
