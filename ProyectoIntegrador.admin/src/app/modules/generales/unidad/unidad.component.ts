...
import { EditUnidadModalComponent } from './components/edit-unidad-modal/edit-unidad-modal.component';
...
export class UnidadComponent
  ...
  create() {
    if (this.accesosService.puedeCrear('generales.unidad.crear')) {
      const modalRef = this.modalService.open(EditUnidadModalComponent, { size: 'md', backdrop: 'static' });
  ...
  edit(id: number) {
    if (this.accesosService.puedeEditar('generales.unidad.editar')) {
      const modalRef = this.modalService.open(EditUnidadModalComponent, { size: 'md', backdrop: 'static' });
