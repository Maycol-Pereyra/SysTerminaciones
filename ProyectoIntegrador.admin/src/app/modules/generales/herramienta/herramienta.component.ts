...
import { EditHerramientaModalComponent } from './components/edit-herramienta-modal/edit-herramienta-modal.component';
...
export class HerramientaComponent
  ...
  constructor(
    ...
    public service: HerramientaService
  ) { }
  ...
  create() {
    if (this.accesosService.puedeCrear('generales.herramienta.crear')) {
      const modalRef = this.modalService.open(EditHerramientaModalComponent, { size: 'md', backdrop: 'static' });
  ...
  edit(id: number) {
    if (this.accesosService.puedeEditar('generales.herramienta.editar')) {
      const modalRef = this.modalService.open(EditHerramientaModalComponent, { size: 'md', backdrop: 'static' });
