...
import { EditVehiculoModalComponent } from './components/edit-vehiculo-modal/edit-vehiculo-modal.component';
...
export class VehiculoComponent
  ...
  create() {
    if (this.accesosService.puedeCrear('generales.vehiculo.crear')) {
      const modalRef = this.modalService.open(EditVehiculoModalComponent, { size: 'lg', backdrop: 'static' });
  ...
  edit(id: number) {
    if (this.accesosService.puedeEditar('generales.vehiculo.editar')) {
      const modalRef = this.modalService.open(EditVehiculoModalComponent, { size: 'lg', backdrop: 'static' });
