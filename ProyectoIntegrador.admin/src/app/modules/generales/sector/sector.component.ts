...
import { EditSectorModalComponent } from './components/edit-ciudad-modal/edit-sector-modal.component';
...
export class SectorComponent
  ...
  create() {
    if (this.accesosService.puedeCrear('generales.sector.crear')) {
      const modalRef = this.modalService.open(EditSectorModalComponent, { size: 'md', backdrop: 'static' });
  ...
  edit(id: number) {
    if (this.accesosService.puedeEditar('generales.sector.editar')) {
      const modalRef = this.modalService.open(EditSectorModalComponent, { size: 'md', backdrop: 'static' });
