...
import { EditSolicitudTomaMedidaModalComponent as EditSolicitudTomaMedidaModalComponent } from './components/edit-solicitud-toma-medida-modal/edit-solicitud-toma-medida-modal.component';
...
@Component({
  ...
  templateUrl: './solicitud-toma-medida.component.html'
})
export class SolicitudTomaMedidaComponent
  implements
  OnInit,
  OnDestroy,
  IEditAction,
  ...
  constructor(
    ...
    public service: SolicitudTomaMedidaService
  ) { }
  ...
  create() {
    if (this.accesosService.puedeCrear('ventas.solicitud-toma-medida.crear')) {
      const modalRef = this.modalService.open(EditSolicitudTomaMedidaModalComponent, { size: 'lg', backdrop: 'static' });
