...
@Component({
  selector: 'app-info-cotizacion-modal',
  templateUrl: './info-cotizacion-modal.component.html',
})
export class InfoCotizacionModalComponent extends FormBase implements OnInit, OnDestroy {
  @Input() id: number;
