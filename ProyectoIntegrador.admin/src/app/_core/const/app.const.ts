...
export class EndPointSelect {
  ...
  public static readonly pais = '/api/pais/item-select';
  public static readonly provincia = '/api/provincia/item-select';
  public static readonly ciudad = '/api/ciudad/item-select';
  public static readonly sector = '/api/sector/item-select';
  public static readonly cliente = '/api/cliente/item-select';
  public static readonly suplidor = '/api/suplidor/item-select';
  ...
  public static readonly telefono = '/api/telefono/item-select';
  public static readonly producto = '/api/producto/item-select';
  public static readonly estadoSolicitudTomaMedida = '/api/defecto/item-select';
